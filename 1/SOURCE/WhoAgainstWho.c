...
fs_read(HeaderFile, &TextureData[CurrentChar][WhichTexture], sizeof(WhoAgainstWhoTextureDataStruct));
}
...
if(MusicWorks == 1) cdrom_cdda_play(WhoAgainstWhoTrack, WhoAgainstWhoTrack, 0, CDDA_TRACKS);
