...
fs_read(InputFile, &LifeBarData[CurrentChar], sizeof(SingleLifeBarStruct));
...
fs_read(InputFile, &OtherGuiData[CurrentChar], sizeof(OtherGuiStruct));
...
fs_read(InputFile, TimerHeaderData, sizeof(TimerStruct));

for(CurrentChar=0; CurrentChar<TimerCharacterAmount; CurrentChar++) fs_read(InputFile, &TimerCharacterData[CurrentChar], sizeof(FontSingleCharacterStruct));
