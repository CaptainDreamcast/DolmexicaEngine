...
CheckLengthX = (DrawCharX[LeftChar]+CharacterTextureSize-DrawCharX[RightChar])/CharacterStretchFactor;
...
CheckLengthX = (SpecialEffectUniversalDrawX[LeftChar]+CharacterTextureSize-SpecialEffectUniversalDrawX[RightChar])/CharacterStretchFactor;
