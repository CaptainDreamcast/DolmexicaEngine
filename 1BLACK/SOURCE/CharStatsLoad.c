...
CharStatsFile = fs_open(STAFile, O_RDONLY);

CurrentOffset = fs_seek(CharStatsFile, OriginalOffset, 0);
fs_read(CharStatsFile, &ValueBuffer, sizeof(CharacterBaseValuesStruct));

fs_close(CharStatsFile);
