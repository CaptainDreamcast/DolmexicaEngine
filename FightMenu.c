    ...
    int FightMenuFunction(int FightStage, int LeftStageBorder, BackGroundHeaderStruct BackGroundHeaderData, BackGroundStruct BackGroundData[], BackGroundAnimationStruct BackGroundAnimationData[], pvr_ptr_t BackGroundTextures[], char CharacterName[][10], CharacterTextureStruct CharacterTexture[], char AnimationBuffer[][10], char WhichAnimationFrame[], int DrawCharX[], int PosCharY[], char CharIsLeft[], int CharHealth[], short SpecialLeft[], char RealCharName[][20], char PointArray[][9], PaletteData CharPalette[], int StageGround, int ShadowPositionX, int ShadowPositionY, int CharacterTextureSizeDrawn, int CharacterTextureSizeReal[], char FirstTimerValue, char SecondTimerValue, pvr_ptr_t NewTimerTexture, TimerStruct TimerHeaderData, FontSingleCharacterStruct TimerCharacterData[], char CharWins[], SingleLifeBarStruct LifeBarData[], pvr_ptr_t LifeBarTexture[], pvr_ptr_t VictoryTexture[], OtherGuiStruct OtherGuiData[], char CharIsHuman[], int* Winner, uint8 DrawCharDifferently[], char StageName[]){
    ...
    //DrawCharLite(CharacterTexture[CurrentChar], DrawCharX[CurrentChar], PosCharY[CurrentChar], CharIsLeft[CurrentChar], CharPalette[CurrentChar], StageGround, ShadowPositionX, ShadowPositionY, CharacterTextureSizeDrawn, CharacterTextureSizeReal[CurrentChar], DrawCharDifferently[CurrentChar]);
